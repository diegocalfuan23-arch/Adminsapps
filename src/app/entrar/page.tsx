...
/**
 * Entrada al panel. El formulario de registro solo sirve mientras
 * REGISTRO_ABIERTO="si" en el servidor; si está cerrado, Better Auth
 * responde con error y no crea nada.
 */
export default function EntrarPage() {
  ...
  async function manejar(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (resultado.error) {
      ...
      setError(
        registrando
          ? "No se pudo crear la cuenta. ¿Está abierto el registro?"
